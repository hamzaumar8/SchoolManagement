    ...
    <div class="nano">
        <div class="nano-content">
            <ul>
                ...
                <li><a href="../documentation/index.html"><i class="fa fa-gear"></i> {{ __('School Settings') }}</a>
                </li>
                <li><a href="../documentation/index.html"><i class="fa fa-gears"></i> {{ __('General Settings') }}</a>
                </li>
