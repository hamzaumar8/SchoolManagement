   ...
   <aside
       ...
       <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full">
           <ul class="flex flex-col pl-0 mb-0">
               ...
               <li class="mt-0.5 w-full">
                   <x-nav-link :href="route('staff.classes_subjects')"
                       :active="request()->routeIs('staff.classes_subjects')">
                       <x-slot name="icon">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                               class="w-full h-full">
                               <path
               ...
               <li class="mt-0.5 w-full">
                   <x-nav-link :href="route('staff.assessment.index')"
                       :active="request()->routeIs('staff.assessment.index')">
                       <x-slot name="icon">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                               class="w-full h-full">
                               <path
               ...
               <li class="mt-0.5 w-full">
                   <x-nav-link :href="route('staff.report.index')" :active="request()->routeIs('staff.report.index')">
                       <x-slot name="icon">
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                               class="w-full h-full">
                               <path fill-rule="evenodd"
