...
<a
    {{ $attributes->merge(['class' => 'py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-3 font-semibold text-slate-700 transition-colors shadow-none']) }}>
