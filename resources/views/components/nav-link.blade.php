...
: 'shadow-soft-2xl mr-2 flex h-9 w-9 items-center justify-center rounded-lg bg-center fill-current stroke-0 bg-white
...
items-center whitespace-nowrap rounded-lg px-3 font-semibold text-gray-100 transition-colors shadow-none';
@endphp
