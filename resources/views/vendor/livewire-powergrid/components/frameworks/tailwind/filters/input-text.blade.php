...
<div>
    ...
    <div @class([ 'p-2'=> !$inline,
        ...
        @endif
        <div @class([ 'sm:flex w-full'=> !$inline,
            ...
            <div @class([ 'pl-0 pt-1 w-full sm:w-1/2'=> !$inline,
                ...
                <input data-id="{{ $field }}" @if(isset($enabledFilters[$field]['disabled']) &&
                    boolval($enabledFilters[$field]['disabled'])===true) disabled @else
                    ...
                    @endif type="text" class="power_grid {{ $theme->inputClass }}"
