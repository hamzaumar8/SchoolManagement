<x-app-layout>
    <x-table-card header="" back="{{ route('addmissions.index') }}">
        ...
        <x-html-print>
            <div class="text-sm">
                <div class="grid grid-cols-4 items-center pb-8">
                    ...
                    <div class="flex justify-center items-center">
                        <img src="{{asset('assets/img/addmission')}}/{{$addmission->passport_picture}}" class="h-40"
                            alt="">
                    </div>
                </div>
                <table
                ...
                <table class="w-full border border-spacing-1 border-separate border-black text-left px-2 py-1">
                    <tbody>
                        <tr>
                ...
                <table
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="20%">
                                <div class="border border-black p-0.5 relative inline-block h-[20px] w-[20px]">
                        ...
                        <tr>
                            ...
                            <td width="20%">
                                <div class="border border-black p-0.5 inline-block h-[20px] w-[20px]">
                                    <i class="{{ $addmission->emotinal_control == 'A' ? 'fas fa-check' : '' }}">
                                    </i>
                                </div>
                            </td>
                            <td width="20%">
                                <div class="border border-black p-0.5 relative inline-block h-[20px] w-[20px]">
                                    <i class="{{ $addmission->emotinal_control == 'B' ? 'fas fa-check' : '' }}"></i>
                                </div>
                            </td>
                            <td width="20%">
                                <div class="border border-black p-0.5 relative inline-block h-[20px] w-[20px]">
                                    <i class="{{ $addmission->emotinal_control == 'C' ? 'fas fa-check' : '' }}"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="20%">
                                <div class="border border-black p-0.5 relative inline-block h-[20px] w-[20px]">
                                    <i class="{{ $addmission->friendliness == 'A' ? 'fas fa-check' : '' }}"></i>
                                </div>
                            </td>
                            <td width="20%">
                                <div class="border border-black p-0.5 relative inline-block h-[20px] w-[20px]">
                            ...
                            <td width="20%">
                                <div class="border border-black p-0.5 relative inline-block h-[20px] w-[20px]">
                                    <i class="{{ $addmission->friendliness == 'C' ? 'fas fa-check' : '' }}"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="20%">
                                <div class="border border-black p-0.5 relative inline-block h-[20px] w-[20px]">
                                    <i class="{{ $addmission->work_habits == 'A' ? 'fas fa-check' : '' }}"></i>
                                </div>
                            </td>
                            <td width="20%">
                                <div class="border border-black p-0.5 relative inline-block h-[20px] w-[20px]">
                                    <i class="{{ $addmission->work_habits == 'B' ? 'fas fa-check' : '' }}"></i>
                                </div>
                            </td>
                            <td width="20%">
                                <div class="border border-black p-0.5 relative inline-block h-[20px] w-[20px]">
                                    <i class="{{ $addmission->work_habits == 'C' ? 'fas fa-check' : '' }}"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
