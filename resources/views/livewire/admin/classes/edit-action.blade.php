    ...
    <div class="py-2">
        <form wire:submit.prevent="editClass">
            <div class="font-normal text-gray-600">
                ...
                <div class="mb-4 z-50">
                    <x-select label="Class Name" placeholder="Select Class Name" :async-data="route('api.classnames.index')" option-label="name"
                        class="uppercase" option-value="id" wire:model.defer="name" />
                </div>
                ...
                <div class="mb-4">
                    <x-native-select label="Class Type" placeholder="Select one" :options="[
                        ...
                        option-value="value" class="uppercase" wire:model.defer="class_type" required />
                </div>
                <div class="mb-4">
                    <x-native-select label="Campus" placeholder="Select one" :options="[['value' => 'north', 'name' => 'North'], ['value' => 'south', 'name' => 'South']]" option-label="name"
                        option-value="value" class="uppercase" wire:model.defer="campus" required />
                </div>
