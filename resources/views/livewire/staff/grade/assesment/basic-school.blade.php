<div>
            ...
            <tbody class="text-slate-800">
                ...
                <tr class="table-t-r">
                    ...
                    <td class=" capitalize px-3 py-2 whitespace-nowrap dark:text-slate-200">
                        <span class="">
                            <div>
                                <input type="" wire:model="grades.{{ $index }}.cat1" class="w-[80px] py-1 px-2 bg-gray-50 border-2 @error('grades.' .$index. '.cat1') border-red-500 @enderror text-slate-900 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                        </span>
                    </td>
                    <td class=" capitalize px-3 py-2 whitespace-nowrap dark:text-slate-200">
                        <span class="">
                            <div>
                                <input type="" wire:model="grades.{{ $index }}.gw" class="w-[80px] py-1 px-2 bg-gray-50 border-2 @error('grades.' .$index. '.gw') border-red-500 @enderror text-slate-900 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                        </span>
                    </td>
                    <td class=" capitalize px-3 py-2 whitespace-nowrap dark:text-slate-200">
                        <span class="">
                            <div>
                                <input type="" wire:model="grades.{{ $index }}.cat2" class="w-[80px] py-1 px-2 bg-gray-50 border-2  @error('grades.' .$index. '.cat2') border-red-500 @enderror text-slate-900 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                        </span>
                    </td>
                    <td class=" capitalize px-3 py-2 whitespace-nowrap dark:text-slate-200">
                    ...
                    <td class=" capitalize px-3 py-2 whitespace-nowrap dark:text-slate-200">
                        <span class="">
                            <div>
                                <input type="" wire:model="grades.{{ $index }}.exam" class="w-[80px] py-1 px-2 bg-gray-50 border-2 @error('grades.' .$index. '.exam') border-red-500 @enderror text-slate-900 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                            </div>
                        </span>
                    </td>
                    <td class=" capitalize px-3 py-2 whitespace-nowrap dark:text-slate-200">
    ...
    <div>
        ...
        <div class="flex items-center justify-between mt-4 space-x-5">
            ...
            <x-button rose wire:click.prevent="submit" spinner="submit" :label="__('Save and Submit')" class="w-1/2 uppercase font-bold" />
        </div>
        @endif
    </div>
</div>