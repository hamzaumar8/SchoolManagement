    ...
    <div class="mb-4">
        <div class="flex items-center space-x-2">
            ...
            <div class="flex">
                ...
                <div>
                    <x-input type="date" max="{{now()->format('Y-m-d')}}" wire:model.lazy="attendance_date" />
                </div>
            </div>
        </div>
    </div>
            ...
            <tr>
                ...
                <td class="pg-actions px-3 py-2 whitespace-nowrap dark:text-slate-200">
                    <div class="w-full md:w-auto">
                        <x-button blue spinner="addAttendance" wire:click="addAttendance('{{$attendance->id}}')" :label="__('save')" />
                    </div>
                </td>
            </tr>
        </tbody>
