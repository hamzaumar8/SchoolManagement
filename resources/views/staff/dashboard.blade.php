<x-app-layout header="{{ __('Dashboard') }}">
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block">
                                <div
                                    class="flex justify-center items-center w-12 h-12 text-center rounded-lg bg-blue-500">
                                    <span class="text-xl font-bold text-white">
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block">
                                <div
                                    class="flex justify-center items-center w-12 h-12 text-center rounded-lg bg-lime-500">
                                    <span class="text-xl font-bold text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block">
                                <div
                                    class="flex justify-center items-center w-12 h-12 text-center rounded-lg bg-pink-500">
                                    <span class="text-xl font-bold text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2  mt-6 -mx-3">
        <div class="w-full max-w-full px-3 mb-6 sm:flex-none xl:mb-0">
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                            ...
                            <li class="relative border-b border-gray-200" x-data="{subject:null}">
                                ...
                                <div class="relative overflow-hidden transition-all max-h-0 duration-700"
                                    ...
                                    <div class="p-6  border-t">
                                        <a
                                            href="{{ route('staff.assessment.class_subject', [$subject->class_id,$subject->subject_id]) }}">{{$subject->class->name}}</a>
                                    </div>
                                </div>
