...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('addmissions', function (Blueprint $table) {
            ...
            $table->string('gaurdian_email')->nullable();
            $table->string('gaurdian_phone_number')->nullable();
            $table->string('gaurdian_occupation')->nullable();
            $table->string('gaurdian_home_digital_address')->nullable();
            $table->string('gaurdian_postal_address')->nullable();
            $table->enum('gaurdian_relation', ['uncle', 'aunty', 'sibling', 'guardian', 'other']);
            $table->text('gaurdian_picture')->nullable();
